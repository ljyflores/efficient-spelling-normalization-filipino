...
![Generated Rule Dictionary](https://github.com/ljyflores/Filipino-Slang/blob/main/results/Example_Dictionary.png)

And this is an example of how inference is performed after likelihood scores are calculated with the previous dictionary:

![Inference](https://github.com/ljyflores/Filipino-Slang/blob/main/results/Example.png)
...
![Cutoff vs Accuracy @ 1](https://github.com/ljyflores/Filipino-Slang/blob/main/results/cutoff_vs_acc.png)
![Cutoff vs Inference Time (s)](https://github.com/ljyflores/Filipino-Slang/blob/main/results/cutoff_vs_time.png)
